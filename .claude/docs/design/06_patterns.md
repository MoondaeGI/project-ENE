...
## Retrieval with Memory Evolution
...
## Portrait-Aware Response Generation
...
async def build_user_portrait(user_id: str):
    ...
    portrait = await llm.synthesize_portrait({
        "personality": filter_by_category(reflections, "personality"),
        "style": filter_by_category(reflections, "communication"),
        "interests": filter_by_category(reflections, "interests")
    })
